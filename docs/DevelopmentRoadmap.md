...
- [x] Play Store launch prep (Sprint 9 — data safety form complete, content rating questionnaire answered, AAB build verified, signing via env vars; see PlayStoreListing.md)
- [x] F-Droid submission prep (Sprint 9 — fastlane metadata created, FOSS APK Sentry-free verified, checklist in FDroidMetadata.md)
- [x] Crowdin i18n (Sprint 9 — crowdin.yml added, values-fr sample locale proves locale-switcher pipeline)
