...
class MediaViewModelTest {
    ...
    private lateinit var holder: SelectedImagesHolder
    ...
    fun setUp() {
        ...
        holder = SelectedImagesHolder()
        viewModel = MediaViewModel(getAllImagesUseCase, findDuplicateImagesUseCase, holder)
    }
